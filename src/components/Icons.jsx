 ...
 *
 * Using inline SVGs (instead of an icon library) keeps the project
 * dependency-free and easy to expand. Every icon accepts standard SVG
 * props (className, etc.) and inherits color via `currentColor`.
 */
...
export function Salad(props) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M13 12a2.4 2.4 0 0 0-2.4-2.4" />
    </svg>
  );
}
